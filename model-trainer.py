# -*- coding: utf-8 -*-
"""gesture-notebook.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1cWl4l9B2kncWxoBhKu_CoFyN8YogpKJf
"""
...
for path in range(0, len(dataset_path)):
    dataset_path = "/kaggle/input/databasegestures/data/" + str(list_of_gestures[path])
